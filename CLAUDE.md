...
PlacementPrep — a single-page React app for spaced-repetition practice of CS fundamentals (DBMS, OS, CN, OOP) and DSA logic drills, wrapped with Capacitor for iOS. There is no backend; all state lives in `localStorage` on the device.
